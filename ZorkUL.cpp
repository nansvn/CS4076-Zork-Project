...
ZorkUL::~ZorkUL() {
    cout << "Deleting ZorkUL" << endl;
}


void ZorkUL::createRooms()  {
    Room *bedroom, *b, *c, *d, *e, *f, *g, *h, *i;
...
//             (N, E, S, W)
    ...
    b->setExits(NULL, NULL, NULL, bedroom);
    c->setExits(NULL, bedroom, NULL, NULL);
    d->setExits(bedroom, e, NULL, i);
	e->setExits(NULL, NULL, NULL, d);
    f->setExits(NULL, g, bedroom, h);
